...
def run_create_script(host, port, user, password, database, create_script_path):
    psql_command = [
        'psql',
        '-h', host,
        '-p', str(port),
...
# Path to the SQL script for creating the database schema
create_script = '2307_2325_schema.sql'

# creating the database
run_create_script(args.host, args.port, args.user,
                  args.password, args.database, create_script)
